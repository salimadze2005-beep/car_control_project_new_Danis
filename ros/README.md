...
> Это сохранённая инструкция ROS1/Jetson. В ветке `simulation` core вынесен в
> `shared/`, а FSDS/ROS2, Windows и local/remote запуск описаны в
> [docs/SIMULATION_SETUP.md](../docs/SIMULATION_SETUP.md). Для новой FSDS-интеграции
> используйте её; команды ниже относятся только к прежнему ROS1-профилю.
